  ...
  <section id="playground" class="py-24 bg-slate-50 dark:bg-slate-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="card p-6">
            <div class="flex items-center justify-between mb-4">
              <label class="text-sm font-bold text-slate-700 dark:text-slate-300">HTML</label>
            </div>
            <textarea v-model="inputHtml"
                      class="w-full h-64 p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg font-mono text-sm text-slate-800 dark:text-slate-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent resize-none"
          ...
          <div class="card p-6">
            <div class="flex items-center justify-between mb-4">
              <label class="text-sm font-bold text-slate-700 dark:text-slate-300">CSS</label>
            </div>
          ...
          <div class="card p-6">
            <div class="flex items-center justify-between mb-4">
              <label class="text-sm font-bold text-slate-700 dark:text-slate-300">JavaScript</label>
            </div>
        ...
        <div class="card p-6">
          <div class="flex items-center justify-between mb-4">
            <label class="text-sm font-bold text-slate-700 dark:text-slate-300">Inlined HTML Output</label>
          ...
          <textarea v-model="outputHtml"
                    readonly
                    class="w-full h-96 p-4 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 rounded-lg font-mono text-sm text-slate-800 dark:text-slate-200 resize-none"
